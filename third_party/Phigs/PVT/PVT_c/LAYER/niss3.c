...
**************************************************************************/
#ifdef NO_PROTO
niss3 (srpx, srpy, srpz, sdist, spthsz, spath, mclipf, srchci,
       nfln, nflisx, nflis, nflesx, nfles,
       ifln, iflisx, iflis, iflesx, ifles, ipthsz,
       errind, fpthsz, fpath)
   real    *srpx,
            *srpy,
            *srpz,
   ...
   integer      *spthsz,
            ...
            *fpthsz,
             fpath[][2];
#else
niss3 (real *srpx, real *srpy, real *srpz, real *sdist, integer *spthsz,
       integer spath[][2], integer *mclipf, integer *srchci,
       integer *nfln, integer nflisx[], integer nflis[], integer nflesx[], integer nfles[],
       integer *ifln, integer iflisx[], integer iflis[], integer iflesx[], integer ifles[],
       integer *ipthsz, integer *errind, integer *fpthsz, integer fpath[][2])
#endif
{
   Pint             cerror, i, j;
   Pint             st;
...
**************************************************************************/
   ...
   pincr_spa_search3 (&ref, dist, &sp, clip, ceil, &norm, &invt,
