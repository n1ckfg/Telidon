/* fort/04/02/03/02/p17.f -- translated by f2c (version of 22 July 1992  22:54:52).
...
static real c_b60 = .066666666666666666f;
#else /* NO_PROTO */
static real c_b58 = (float).15;
static real c_b60 = (float).066666666666666666;
#endif /* NO_PROTO */

/*  ********************************************************* */
/*  *                                                       * */
/*  *    TEST NUMBER: 04.02.03.02/17                        * */
...
#endif /* NO_PROTO */
{
    ...
    extern /* Subroutine */ int idmat_(integer *, real *), endit_(void), 
	    nschh (real *), nscmd (integer *, integer *), nbltm (real *, real 
	    *, real *, real *, real *, real *, real *, integer *, real *), 
	    nclst (void);
#else /* NO_PROTO */
    extern /* Subroutine */ int idmat_(), endit_(), nschh (), nscmd (), 
	    nbltm (), nclst ();
#endif /* NO_PROTO */
    ...
    extern /* Subroutine */ int initgl_(char *, ftnlen), xpopph_(integer *, 
	    ...
	    , nstxal (integer *, integer *), loctxt_(integer *, real *), 
    ...
    extern /* Subroutine */ int initgl_(), xpopph_(), setval_(), setasf_(), 
	    nstxal (), loctxt_(), chkinq_(), numlab_(), setmsg_(), dchpfv_();
#endif /* NO_PROTO */
...
/*  generates text primitive #5,6 on first invocation, and 11,12 */
...
/*  draw labels */
    r__1 = ylocel_(&c__1);
    numlab_(&c__14, &c_b58, &r__1, &c_b60);
    nclst ();
#ifndef NO_PROTO
    setmsg_("3 5 6 8 9", "The text index should be saved and restored by <ex"
	    "ecute structure> during traversal.", 9L, 84L);
    dchpfv_("STRUCTURE NETWORK INHERITANCE FOR TEXT INDEX: Which pair of tex"
	    "t primitives does NOT match?", &c__14, &perm[13], 91L);
#else /* NO_PROTO */
    setmsg_("3 5 6 8 9", "The text index should be saved and restored by <ex\
ecute structure> during traversal.", 9L, 84L);
    dchpfv_("STRUCTURE NETWORK INHERITANCE FOR TEXT INDEX: Which pair of tex\
