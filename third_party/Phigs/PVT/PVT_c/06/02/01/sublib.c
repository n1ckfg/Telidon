/* fort/06/02/01/sublib.f -- translated by f2c (version of 22 July 1992  22:54:52).
...
/*     (cent1x approx= cent2x and cent1y approx= cent2y) */
    L__1 = appeq_(npcpt, &npcpt[1], &c_b24, &c_b25) && appeq_(&npcpt[2], &
	    npcpt[3], &c_b24, &c_b25);
    ifpf_(&L__1);
#ifndef NO_PROTO
    return 0;
