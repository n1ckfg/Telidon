/* e04154.f -- translated by f2c (version of 22 July 1992  22:54:52).
...
#ifndef NO_PROTO
static real c_b48 = .01f;
#else /* NO_PROTO */
static real c_b48 = (float).01;
#endif /* NO_PROTO */
...
/*  try 3D cases first */
    ...
    L__1 = streq_("OO**", 4L) && rareq_(&c__16, qrotmt, rotmt3, &c_b48, &
	    c_b48) && rareq_(&c__16, qmapmt, mapmt3, &c_b48, &c_b48) && 
	    rareq_(&c__6, vwcp1, vwcp0, &c_b48, &c_b48) && pcl1 == 0 && pcl2 
	    == 0 && pcl3 == 0;
    tstign_(&L__1);
/*  now test 2D cases */
    ...
    rsvwr_(&globnu_1.wkid, &c__1, rotmt, mapmt, vwcp4, &c__0);
    etr3_(&c_b10, &c_b16, &c_b78, rotmt3);
    etr3_(&c_b17, &c_b18, &c_b78, mapmt3);
    nqvwr (&globnu_1.wkid, &c__1, &c__1, &errind, &idum1, qrotmt, qmapmt, 
	    vwcp1, &pcl1, &pcl2, &pcl3);
    chkinq_("pqvwr", &errind, 5L);
    L__1 = streq_("OO**", 4L) && rareq_(&c__16, qrotmt, rotmt3, &c_b48, &
	    c_b48) && rareq_(&c__16, qmapmt, mapmt3, &c_b48, &c_b48) && 
	    rareq_(&c__6, vwcp1, vwcp40, &c_b48, &c_b48) && pcl1 == 1 && pcl2 
	    == 1 && pcl3 == 1;
    tstign_(&L__1);
    nclwk (&globnu_1.wkid);
    enderr_();
