C  *********************************************************
C  *                                                       *
C  *    TEST NUMBER: 04.02.03.01/06                        *
C  *    TEST TITLE : Text path and character height,       *
C  *                 expansion factor, spacing, and up     *
C  *                 vector                                *
C  *                                                       *
...
C  set up 102 as sub-structure
      ...
      CALL SETMSG ('11 14 31 64 65 66 67 79 80 81', 'Text path ' //
     1             'should specify the direction in which '      //
     2             'successive characters are generated and '    //
     3             'character up vector should rotate the '      //
     4             'resulting primitive.')
      CALL TXPCUP ('T')
      CALL PEMST (102)
...
100   CONTINUE
      ...
      CALL SETMSG ('11 18 27 31 35 36 37 41 42 43 58 59 60 61 66 67 69',
     1             'The size and shape of a text string displayed '   //
     2             'with STROKE precision in a monospaced font on a ' //
     3             'horizontal text path should conform exactly to '  //
     4             'the character height, expansion factor, and '     //
     5             'spacing in effect.')

      CALL DCHPFV ('CHARACTER HEIGHT, EXPANSION, AND SPACING IN ' //
     1             'HORIZONTAL TEXT: In which line are the '      //
     2             'characters of the text string NOT aligned '   //
     3             'within dotted character boxes and on the '    //
     4             'dashed baseline?', NUMLIN, NGLINE)
...
200   CONTINUE
      ...
      CALL SETMSG ('11 18 27 31 35 36 37 41 42 43 58 59 60 61 66 67 68',
     1             'The size and shape of a text string displayed '   //
     2             'with STROKE precision in a monospaced font on a ' //
     3             'vertical text path should conform exactly to '    //
     4             'the character height, expansion factor, and '     //
     5             'spacing in effect.')
      CALL DCHPFV ('CHARACTER HEIGHT, EXPANSION, AND SPACING IN ' //
     1             'VERTICAL TEXT: In which column are the '      //
     2             'characters of the text string NOT aligned '   //
     3             'within dotted character boxes and on the '    //
     4             'dashed centerline?', NUMCOL, NGCOL)
      CALL PEMST (102)
...
400   CONTINUE
      ...
      CALL SETMSG ('11 27 31 35 36 37 41 42 43 58 59 60 61 66 67 69',
     1             'The size and shape of a text string displayed '  //
     2             'with STROKE precision in any font on a '         //
     3             'horizontal text path should conform exactly to ' //
     4             'the character height, expansion factor, and '    //
     5             'spacing in effect.')
      CALL DCHPFV ('CHARACTER HEIGHT, EXPANSION, AND SPACING IN ' //
...
500   CONTINUE
      ...
      CALL SETMSG ('11 27 31 35 36 37 41 42 43 58 59 60 61 66 67 68',
     1             'The size and shape of a text string displayed '   //
     2             'with STROKE precision in any font on a vertical ' //
     3             'text path should conform exactly to the '         //
     4             'character height, expansion factor, and spacing ' //
     5             'in effect.')
      CALL DCHPFV ('CHARACTER HEIGHT, EXPANSION, AND SPACING IN ' //
     1             'VERTICAL TEXT: In which column are the '      //
     2             'characters of the text string NOT aligned '   //
