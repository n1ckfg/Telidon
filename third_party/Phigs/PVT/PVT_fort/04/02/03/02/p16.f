...
C  use bundle attributes
      ...
      CALL SETMSG ('3 5 6 64 65', 'A defined text color index '     //
...
C  set text representation ix : color = txtcl
         CALL PSTXR (WKID, IX, 1, PREC, 1.0, 0.2, TXTCI)
...
C  clear out last display from structure
      ...
      CALL SETMSG ('3 5 6 63 64 66', 'An undefined text color index ' //
