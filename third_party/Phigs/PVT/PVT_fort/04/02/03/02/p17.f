...
C text precision
      ...
      REAL         XACT,XEXP,XFORM(3,3)


      CALL INITGL ('04.02.03.02/17')
...
C  generates text primitive #5,6 on first invocation, and 11,12
...
C  draw labels
      ...
      CALL SETMSG ('3 5 6 8 9', 'The text index should be saved ' //
